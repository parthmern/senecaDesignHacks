...
export const Footer = () => {
    ...
    return (
        <footer className="relative productFont bg-hero-gradient">
                ...
                <div className="py-16">
                    <nav className="mt-10 text-sm" aria-label="quick links">
                        <div className="-my-1 flex justify-center gap-x-6">
                            <a className="inline-block rounded-lg px-2 py-1 text-sm text-gray-300 hover:bg-slate-100 hover:text-slate-900" href="#features">Home</a>
                            <a className="inline-block rounded-lg px-2 py-1 text-sm text-gray-300 hover:bg-slate-100 hover:text-slate-900" href="#testimonials">Events</a>
                            <a className="inline-block rounded-lg px-2 py-1 text-sm text-gray-300 hover:bg-slate-100 hover:text-slate-900" href="#pricing">Resources</a>
                        </div>
                    </nav>
                </div>
                <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
                    <div className="flex gap-x-6">
                        <a className="group" aria-label="Curves on X" href="#">
                        ...
                        <a className="group" aria-label="Curves on GitHub" href="#">
                            <svg className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700" aria-hidden="true" viewBox="0 0 24 24">
                    ...
                    <p  className="mt-6 text-sm text-slate-500 sm:mt-0">Designed and created by <span  className='font-bold cursor-pointer ' onClick={()=>{navigate("https://www.linkedin.com/in/parthpatelreal")}} >@parthmern</span> 💚</p>
